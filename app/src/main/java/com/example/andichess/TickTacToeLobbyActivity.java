...
public class TickTacToeLobbyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tick_tac_toe_lobby);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sessionName = playerName;
                sessionRef = database.getReference("TickTacToe/sessions/" + sessionName + "/player1");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                sessionRef = database.getReference("TickTacToe/sessions/" + sessionName + "/player2");
                addSessionEventListener();
                sessionRef.setValue(playerName);
            }
        });
    ...
    private void addSessionEventListener() {
        sessionRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                button.setText("Create Session");
                button.setEnabled(false);
                Intent intent = new Intent(getApplicationContext(), TickTacToeGameActivity.class);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                button.setText("Create Session");
                button.setEnabled(false);
                Toast.makeText(TickTacToeLobbyActivity.this, "Error Creating Session", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        sessionsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : sessions) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<>(TickTacToeLobbyActivity.this, android.R.layout.simple_list_item_1, sessionList);
